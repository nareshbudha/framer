...
import logoImage from "../Components/assets/Image/Logo BNM.jpg";
import { Link } from "react-router-dom";
const Footer = () => {
  const today = new Date();
  return (
    <div className="w-full  ">
      <div className="bg-[#265CC0] flex flex-col rounded-3xl mobile:py-10 mobile:gap-10 tablet:flex-col tablet:gap-5 tablet:px-10 tabletmd:flex-row ">
